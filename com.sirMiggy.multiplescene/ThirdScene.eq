...
public class ThirdScene : SEScene
{
	...
	rsc.prepare_image("img","home",get_scene_width()*0.25,get_scene_height()*0.10);
        ...
        but3 = add_sprite_for_color(Color.instance("red"), 0.25*get_scene_width(), 0.25*get_scene_height());
       ...
       rsc.prepare_font("myfont","ariel bold color=#551a8b",40);
        ...
        text5.move(0.75*get_scene_width(),0.8*get_scene_height());

       display = add_sprite_for_text("Green SCREEN","titlefont");
