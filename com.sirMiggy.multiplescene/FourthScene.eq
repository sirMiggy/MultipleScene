public class FourthScene : SEScene
{
    ...
    public void initialize(SEResourceCache rsc) {
        ...
        but4 = add_sprite_for_color(Color.instance("red"), 0.25*get_scene_width(), 0.25*get_scene_height());
        but4.move(0.75*get_scene_width(),0.9*get_scene_height());

		rsc.prepare_font("myfont","ariel bold color=#551a8b",40);	
		 rsc.prepare_font("titlefont","ariel bold color=black",100);
        ...
        text5.move(0.75*get_scene_width(),0.9*get_scene_height());
     	
         display = add_sprite_for_text("White SCREEN","titlefont");
